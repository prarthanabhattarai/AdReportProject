...
if __name__ == '__main__':
    ...
    cons1 = Consumer(addr="52.8.165.110", group="hdfs", topic="fb_bids")
    cons1.consume_topic("/home/ubuntu/user/AdReport/kafka_messages_bids")
    
    print "\nConsuming messages for ads..."
    cons2 = Consumer(addr="52.8.165.110", group="hdfs", topic="fb_ads")
    cons2.consume_topic("/home/ubuntu/user/AdReport/kafka_messages_ads")
